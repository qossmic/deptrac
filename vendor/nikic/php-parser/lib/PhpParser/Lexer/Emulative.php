...
namespace DEPTRAC_202401\PhpParser\Lexer;

use DEPTRAC_202401\PhpParser\Error;
use DEPTRAC_202401\PhpParser\ErrorHandler;
use DEPTRAC_202401\PhpParser\Lexer;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use DEPTRAC_202401\PhpParser\Lexer\TokenEmulator\TokenEmulator;
