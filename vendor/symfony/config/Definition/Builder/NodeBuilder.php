 ...
 */
namespace DEPTRAC_202403\Symfony\Component\Config\Definition\Builder;
...
class NodeBuilder implements NodeParentInterface
{
    ...
    {
        if (1 > \func_num_args()) {
            \DEPTRAC_202403\trigger_deprecation('symfony/form', '6.2', 'Calling "%s()" without any arguments is deprecated, pass null explicitly instead.', __METHOD__);
        }
        $this->parent = $parent;
        return $this;
    }
