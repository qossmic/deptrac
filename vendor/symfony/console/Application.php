 ...
 */
namespace DEPTRAC_202402\Symfony\Component\Console;

use DEPTRAC_202402\Symfony\Component\Console\Command\Command;
use DEPTRAC_202402\Symfony\Component\Console\Command\CompleteCommand;
use DEPTRAC_202402\Symfony\Component\Console\Command\DumpCompletionCommand;
use DEPTRAC_202402\Symfony\Component\Console\Command\HelpCommand;
use DEPTRAC_202402\Symfony\Component\Console\Command\LazyCommand;
use DEPTRAC_202402\Symfony\Component\Console\Command\ListCommand;
use DEPTRAC_202402\Symfony\Component\Console\Command\SignalableCommandInterface;
use DEPTRAC_202402\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use DEPTRAC_202402\Symfony\Component\Console\Event\ConsoleCommandEvent;
use DEPTRAC_202402\Symfony\Component\Console\Event\ConsoleErrorEvent;
use DEPTRAC_202402\Symfony\Component\Console\Event\ConsoleSignalEvent;
use DEPTRAC_202402\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use DEPTRAC_202402\Symfony\Component\Console\Exception\CommandNotFoundException;
...
use DEPTRAC_202402\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use DEPTRAC_202402\Symfony\Component\Console\Helper\DebugFormatterHelper;
use DEPTRAC_202402\Symfony\Component\Console\Helper\DescriptorHelper;
use DEPTRAC_202402\Symfony\Component\Console\Helper\FormatterHelper;
use DEPTRAC_202402\Symfony\Component\Console\Helper\Helper;
use DEPTRAC_202402\Symfony\Component\Console\Helper\HelperSet;
use DEPTRAC_202402\Symfony\Component\Console\Helper\ProcessHelper;
use DEPTRAC_202402\Symfony\Component\Console\Helper\QuestionHelper;
use DEPTRAC_202402\Symfony\Component\Console\Input\ArgvInput;
use DEPTRAC_202402\Symfony\Component\Console\Input\ArrayInput;
use DEPTRAC_202402\Symfony\Component\Console\Input\InputArgument;
use DEPTRAC_202402\Symfony\Component\Console\Input\InputAwareInterface;
...
use DEPTRAC_202402\Symfony\Component\Console\Output\ConsoleOutput;
...
use DEPTRAC_202402\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use DEPTRAC_202402\Symfony\Component\Console\Style\SymfonyStyle;
use DEPTRAC_202402\Symfony\Component\ErrorHandler\ErrorHandler;
use DEPTRAC_202402\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
                ...
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal) use($event, $command, $commandSignals) {
                        ...
                        if (\in_array($signal, $commandSignals, \true)) {
                            ...
                            if (null === $exitCode) {
                                \DEPTRAC_202402\trigger_deprecation('symfony/console', '6.3', 'Not returning an exit code from "%s::handleSignal()" is deprecated, return "false" to keep the command running or "0" to exit successfully.', \get_debug_type($command));
                                $exitCode = 0;
                            }
                        }
                        if (\false !== $exitCode) {
