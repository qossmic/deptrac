 ...
 */
namespace DEPTRAC_202402\Symfony\Component\DependencyInjection\LazyProxy;

\DEPTRAC_202402\trigger_deprecation('symfony/dependency-injection', '6.2', 'The "%s" class is deprecated, use "%s" instead.', ProxyHelper::class, \DEPTRAC_202402\Symfony\Component\VarExporter\ProxyHelper::class);
/**
