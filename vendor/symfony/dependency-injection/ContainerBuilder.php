...
use DEPTRAC_202401\Composer\InstalledVersions;
use DEPTRAC_202401\Symfony\Component\Config\Resource\ClassExistenceResource;
use DEPTRAC_202401\Symfony\Component\Config\Resource\ComposerResource;
use DEPTRAC_202401\Symfony\Component\Config\Resource\DirectoryResource;
use DEPTRAC_202401\Symfony\Component\Config\Resource\FileExistenceResource;
...
use DEPTRAC_202401\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use DEPTRAC_202401\Symfony\Component\DependencyInjection\Compiler\Compiler;
use DEPTRAC_202401\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use DEPTRAC_202401\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use DEPTRAC_202401\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use DEPTRAC_202401\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use DEPTRAC_202401\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\LazyServiceInstantiator;
use DEPTRAC_202401\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use DEPTRAC_202401\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \DEPTRAC_202401\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \DEPTRAC_202401\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
