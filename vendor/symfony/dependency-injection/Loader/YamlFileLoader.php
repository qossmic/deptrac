...
use DEPTRAC_202403\Symfony\Component\DependencyInjection\Argument\BoundArgument;
...
use DEPTRAC_202403\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument;
...
use DEPTRAC_202403\Symfony\Component\Yaml\Parser as YamlParser;
use DEPTRAC_202403\Symfony\Component\Yaml\Tag\TaggedValue;
...
class YamlFileLoader extends FileLoader
{
    ...
    {
        if (!\class_exists(\DEPTRAC_202403\Symfony\Component\Yaml\Parser::class)) {
    ...
    private function resolveServices(mixed $value, string $file, bool $isParameter = \false) : mixed
    {
        if ($value instanceof TaggedValue) {
            ...
            if ('service_locator' === $value->getTag()) {
                ...
                $argument = $this->resolveServices($argument, $file, $isParameter);
                if (isset($argument[0])) {
                    \DEPTRAC_202403\trigger_deprecation('symfony/dependency-injection', '6.3', 'Using integers as keys in a "!service_locator" tag is deprecated. The keys will default to the IDs of the original services in 7.0.');
                }
