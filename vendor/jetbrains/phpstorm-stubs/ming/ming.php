...
// Start of ming v.
\class_alias('DEPTRAC_202401\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFFont', 'SWFFont', \false);
...
\class_alias('DEPTRAC_202401\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202401\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('DEPTRAC_202401\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('DEPTRAC_202401\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('DEPTRAC_202401\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
