...
class AstMapGeneratorTest extends TestCase
{
    ...
    public function testBasicDependencyClass(): void
    {
        ...
        static::assertArrayValuesEquals(
            [
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyClassA::9 (Extends)',
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyClassInterfaceA::9 (Implements)',
            ],
        ...
        static::assertArrayValuesEquals(
            [
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyClassInterfaceA::13 (Implements)',
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyClassInterfaceB::13 (Implements)',
            ],
    ...
    public function testBasicTraitsClass(): void
    {
        ...
        static::assertArrayValuesEquals(
            ['Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyTraitB::7 (Uses)'],
            $this->getInheritsAsString($astMap->getClassReferenceByClassName(ClassLikeName::fromFQCN(BasicDependencyTraitC::class)))
        );

        static::assertArrayValuesEquals(
            [
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyTraitA::10 (Uses)',
                'Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyTraitB::11 (Uses)',
            ],
            $this->getInheritsAsString($astMap->getClassReferenceByClassName(ClassLikeName::fromFQCN(BasicDependencyTraitD::class)))
        );

        static::assertArrayValuesEquals(
            ['Tests\SensioLabs\Deptrac\AstRunner\Fixtures\BasicDependency\BasicDependencyTraitA::15 (Uses)'],
