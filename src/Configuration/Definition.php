    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $builder->getRootNode()
            ->children()
                ...
                ->end()
                ->arrayNode('analyzer')
                    ->setDeprecated('qossmic/deptrac', '0.14.1', 'The "%node%" option is deprecated. Use "analyser" instead.')
                    ->children()
                ...
                ->arrayNode('analyser')
                    ->children()
                        ->scalarNode('count_use_statements')
                            ->setDeprecated('qossmic/deptrac', '0.14.1', 'The "%node%" option is deprecated. Use "analyser.types" instead.')
                            ->defaultTrue()
                        ->end()
                        ->arrayNode('types')
                            ->scalarPrototype()->end()
